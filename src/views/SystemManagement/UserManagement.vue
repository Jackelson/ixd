  ...
  <div class="applicationStyle">
          ...
          <el-col :span="19" style="border-left: 1px solid #ebeef5">
            ...
            >
              <el-col class="edit" :span="16">
                <el-button :disabled="!selectGroupId" @click="addDialog"
                  >新增用户</el-button
                >
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-if="
              item.key === 'deptId' ||
              (item.key === 'parentId' && groupDialogStatus === 'create')
            "
            disabled
      ...
      <div class="dialog-footer">
        ...
        <el-button
          v-if="groupDialogStatus === 'create'"
          type="primary"
          @click="createGroup"
          >提交</el-button
        >
        <el-button
          v-else-if="groupDialogStatus === 'update'"
          type="primary"
          @click="updateGroup"
          >提交</el-button
        >
