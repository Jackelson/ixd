<template>
    <div>
        <el-form :model="formData" label-width="140px" style="width: 500px;" ref="ruleFormRef" :rules="rules">
            ...
            <el-form-item prop="appDescribe" label="app描述:">
                <el-input v-model="formData.appDescribe" placeholder="请输入app描述" type="textarea" rows="3" maxlength="100"
                    show-word-limit />
            </el-form-item>
            <el-form-item label="app图标:">
                <el-upload class="avatar-uploader" :show-file-list="false" :on-change="handleAvatarSuccess"
                    accept=".jpg,.png,.jpeg" action="#" :auto-upload="false">
            ...
            <el-form-item prop="appAffiliatedCompany" label="所属公司:">
                <el-input v-model="formData.appAffiliatedCompany" placeholder="请输入所属公司" />
            </el-form-item>
            <el-form-item prop="appIndexUrl" label="首页地址:">
                <el-input v-model="formData.appIndexUrl" placeholder="请输入首页地址" />
            </el-form-item>
            <el-form-item prop="applicationDownloadAddress" label="下载地址:">
                <el-input v-model="formData.applicationDownloadAddress" placeholder="请输入下载地址" />
            </el-form-item>
            ...
            <el-form-item prop="appCheckStatus" label="应用检测状态:">
                <el-select v-model="formData.appCheckStatus" placeholder="请选择应用检测状态" style="width:100%;">
                    <el-option v-for="(v, k) in stateNameOptions" :key="k" :label="v.label" :value="v.value"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="offLineApp" label="是否离线:">
                <el-select v-model="formData.offLineApp" placeholder="请选择应用是否离线" style="width:100%;">
                    <el-option v-for="(v, k) in offLineOptions" :key="k" :label="v.label" :value="v.value"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="businessType" label="业务域:">
                <el-select v-model="formData.businessType" placeholder="请选择应用是否离线" style="width:100%;">
                    <el-option v-for="(v, k) in bussinessTypeOptions" :key="k" :label="v.label"
            ...
            <el-form-item prop="contactPersonTel" label="负责人联系方式:">
                <el-input v-model="formData.contactPersonTel" placeholder="请输入负责人联系方式" />
            </el-form-item>
            <el-form-item prop="contactEmail" label="负责人邮箱:">
                <el-input v-model="formData.contactEmail" placeholder="请输入负责人邮箱" />
            </el-form-item>
            <el-form-item prop="reasonRejection" label="驳回理由:" v-if="formData.state == '审批驳回'">
                <el-input :disabled="true" v-model="formData.reasonRejection" rows="3" type="textarea" maxlength="50"
                    show-word-limit />
            </el-form-item>
        </el-form>
        <div class="dialog-btn">
            <el-button type="primary" @click="handleSave($refs.ruleFormRef)">保存</el-button>
            <el-button type="info" @click="handleCancel">取消</el-button>
        </div>
    </div>
</template>
<script>
import { getBusinessType, uploadFile, appInsert, downloadFile } from "@/api/application";
...
export default {
    ...
    created() {
        this.getBusType()
        this.formData.appIndexUrl = moment(new Date()).format("YYMMDDHHmmss") + '/index.html'
